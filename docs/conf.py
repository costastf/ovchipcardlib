...
version = ovchipcardlib.__version__
# The full version, including alpha/beta/rc tags.
release = ovchipcardlib.__version__
...
htmlhelp_basename = '''ovchipcardlibdoc'''
...
# [howto/manual]).
latex_documents = [
    ('index', '''ovchipcardlib.tex''',
     u'''ovchipcardlib Documentation''',
